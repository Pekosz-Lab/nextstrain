...
ggplot(data_filtered, aes(x = factor(date_run, levels = unique(date_run)), fill = subtype)) +
  geom_bar(position = "stack") +
  labs(title = "Influenza Subtype Frequency Over Time",
...
### Plot 1: Clade Frequency Over Time
h3n2_clades = ggplot(data_h3n2, aes(x = factor(date_run, levels = unique(date_run)), fill = clade)) +
  geom_bar(position = "stack") +
  labs(title = "H3N2 Clade Frequency Over Time",
       x = "Date | Sequencing Run",
       y = "Frequency",
       fill = "Clade") +
  theme_minimal() +
...
### Plot 2: Subclade Frequency Over Time
h3n2_subclades = ggplot(data_h3n2, aes(x = factor(date_run, levels = unique(date_run)), fill = subclade)) +
  geom_bar(position = "stack") +
  labs(title = "H3N2 Subclade Frequency Over Time",
       x = "Date | Sequencing Run",
       y = "Frequency",
       fill = "Subclade") +
  theme_minimal() +
...
generate_plots <- function(df, subtype_name) {
  ...
  clade_plot <- ggplot(df_filtered, aes(x = date_run, fill = clade)) +
    ...
    labs(title = paste(subtype_name, "Clade Frequency Over Time"),
         x = "Date | Sequencing Run",
         y = "Frequency",
         fill = "Clade") +
    theme_minimal() +
  ...
  subclade_plot <- ggplot(df_filtered, aes(x = date_run, fill = subclade)) +
    ...
    labs(title = paste(subtype_name, "Subclade Frequency Over Time"),
         x = "Date | Sequencing Run",
         y = "Frequency",
         fill = "Subclade") +
    theme_minimal() +
