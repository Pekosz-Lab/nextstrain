...
def update_database(db_path, fasta_file, metadata_file):
    ...
    for _, row in metadata_df.iterrows():
        ...
        cursor.execute('''
            INSERT INTO influenza_genomes (seq_id, sample_id, subtype, collection_date, passage_history, study_id)
            VALUES (?, ?, ?, ?, ?, ?)
        ...
        ''', (seq_id, sample_id, subtype, collection_date, passage_history, study_id,
              sample_id, subtype, collection_date, passage_history, study_id))
